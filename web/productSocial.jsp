<%-- 
    Document   : productSocial
    Created on : Nov 16, 2018, 3:22:57 AM
    Author     : jenny
--%>
...
<html>
    <head>
        ...
        <title>Playful Kids : รายการสินค้าด้านสังคม</title>
    </head>
    <body style="margin-top: 70px;">
        ...
        <div class="container">
            ...
            <!-- Image Header -->
            <img class="img-fluid rounded mb-4" src="pic/headersocial.jpg" alt="">
