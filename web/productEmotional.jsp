<%-- 
    Document   : productEmotional
    Created on : Nov 16, 2018, 2:12:06 AM
    Author     : jenny
--%>
...
<html>
    <head>
        ...
        <title>Playful Kids : รายการสินค้าด้านอารมณ์</title>
    </head>
    <body style="margin-top: 70px;">
        ...
        <div class="container">
            ...
            <!-- Image Header -->
            <img class="img-fluid rounded mb-4" src="pic/headeremotion.jpg" alt="">
